...
for movieDict in movies {
    ...
    if let movieName = movieDict["name"] as? String,
        ...
        let movieCast = movieDict["cast"] as? [[String:Any?]],
        ...
        for castMemberInfoDict in movieCast {
            if let actorName = castMemberInfoDict["name"] as? String,
                let birthYear = castMemberInfoDict["birth_year"] as? Int,
                let breakoutYear = castMemberInfoDict["breakout_year"] as? Int,
                let breakoutRole = castMemberInfoDict["breakout_role"] as? String,
                let deathYear = castMemberInfoDict["death_year"] as? Int? {
